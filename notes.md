Hi everyone! My name is Dean Johnson. I am a Senior in Computer Science, studying at
Oregon State University and I am here to tell you about what I did on my internship this year!
...
So for my first project, I got to start working on setting up vagrant. This
...
and is usually pretty quick. For example, my mentor was able to run the server
on his system in under 2 seconds, which is completely manageable. So why was
it taking so long for me to start my server?
...
the server was what was taking a long time, and reloads would not take long at all.
...
"
# Testing the new virtualenv
1. Deploy peep-1035319 to stage.
2. See if the site and cron commands work.
    * Cron commands have had issues relating to the virtualenv in the past.
...
* Reminded of how everything that seems easy can very quickly turn into a mess
